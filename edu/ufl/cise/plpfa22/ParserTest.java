...
@Test
void aliyaTest() throws PLPException
{
	String input = """
            PROCEDURE;
            .
...
@Test
void aliyaTest2() throws PLPException
{
	String input = """
            PROCEDURE a;
			    VAR b;
...
@Test
void aliyaTest3() throws PLPException
{
	String input = """
            VAR abc = 5;
            ! abc
...
@Test
void aliyaTest4() throws PLPException
{
	String input = """
            CONST abc = 012;
            .
...
@Test
void aliyaTest5() throws PLPException
{
	String input = """
            VAR a, b, c;
            c := a +-/ b
...
@Test
void aliyaTest6() throws PLPException
{
	String input = """
            VAR a b c;
            .
...
//testing comments
@Test
void aliyaTest7() throws PLPException
{
	String input = """
            //VAR ignore this;
            VAR var1;
...
@Test
void aliyaTest8() throws PLPException
{
	String input = """
            CONST TRUE = 1;
            .
